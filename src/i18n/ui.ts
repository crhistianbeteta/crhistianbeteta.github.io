...
export const ui = {
    ...
    es: {
        ...
        'skills.frontend.title': 'FrontEnd',
        'skills.backend.title': 'BackEnd',
        'academicbackground.master.title': `Máster en Ingeniería informática`,
        'academicbackground.master.description': `Los estudios fueron cursados en la Escuela Superior de Informática de la Universidad de Castilla-La Mancha, abordando una variedad de temas como realidad virtual, contenerización, computación de altas prestaciones y gestión de proyectos. Sin embargo, el énfasis principal se centró en la computación cuántica, tema explorado en el trabajo de fin de máster (TFM), que recibió la máxima calificación.`,
